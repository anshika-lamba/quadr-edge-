...
def setup_real_imagenet():
    print("=" * 65)
    print("QADR Fix: Ingesting Real ImageNet-1K Validation Set & Labels")
    print("=" * 65)
    ...
    print("[*] Downloading ImageNet-1K sample manifest...")
    try:
        ...
        print(f"[!] Manifest download failed: {e}. Using local fallback...")
        samples = []
    ...
    print(f"[STATUS] Real ImageNet Manifest written to {manifest_path} (N={len(rows)})")
    print("=" * 65)
